...
static void TestDynamicIPAlloc(void)
{
    ip_t ip_subnet = {242, 219, 0, 0}; 
    ip_t ip_zero = {0};
    size_t i = 0; 
    size_t original_count = 0; 
    __uint32_t mask = 0xffff0000; 
    ...
    if (DHCPCount(dhcp) !=  original_count - 100)
    {
...
{ 
    ...
    if (original_count - 40 != DHCPCount(dhcp))
    {
...
static void TestDHCPFree(void)
{
    ...
    if (original_count - 95 == DHCPCount(dhcp))
